...
e. Dada uma cidade, calcular quantas pessoas vivem lá.
f. Qual a cidade com mais habitantes registados no ficheiro?
g. Determinar a quantidade de pessoas em todas as cidades e qual a porcentagem correspondente.
...
total = len(dados)
print("g. Quantidade e porcentagem por cidade:")
