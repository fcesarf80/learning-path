...
• Construir um dicionário onde possa valvar a informação de quantas pessoas existem por zona do
  país (exemplo: {"Norte": X, "Centro": Y, "Sul": Z})
• Calcule a idade média dos contatos.
• Construa um novo dicionário com a idade média por região (ex: {"Norte": média1, "Centro": média2,
  "Sul": média3}
