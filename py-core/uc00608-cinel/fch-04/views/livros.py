...
def criar_tela_livros(frame_principal):
    ...
    tk.Label(frame_formulario, text="Título:", bg=COR_FUNDO).grid(row=0, column=0, padx=10, pady=5, sticky="w")
    entry_titulo = tk.Entry(frame_formulario, width=40)
    entry_titulo.grid(row=0, column=1, padx=10)

    tk.Label(frame_formulario, text="Autor:", bg=COR_FUNDO).grid(row=1, column=0, padx=10, pady=5, sticky="w")
    entry_autor = tk.Entry(frame_formulario, width=40)
    entry_autor.grid(row=1, column=1, padx=10)

    tk.Label(frame_formulario, text="Categoria:", bg=COR_FUNDO).grid(row=2, column=0, padx=10, pady=5, sticky="w")
    entry_categoria = tk.Entry(frame_formulario, width=40)
    entry_categoria.grid(row=2, column=1, padx=10)

    tk.Label(frame_formulario, text="Quantidade:", bg=COR_FUNDO).grid(row=3, column=0, padx=10, pady=5, sticky="w")
    entry_quantidade = tk.Entry(frame_formulario, width=10)
    ...
    btn_adicionar = tk.Button(frame_botoes, text="Adicionar", width=12)
    btn_adicionar.pack(side="left", padx=5)

    btn_editar = tk.Button(frame_botoes, text="Editar", width=12)
    btn_editar.pack(side="left", padx=5)

    btn_remover = tk.Button(frame_botoes, text="Remover", width=12)
    btn_remover.pack(side="left", padx=5)

    btn_pesquisar = tk.Button(frame_botoes, text="Pesquisar", width=12)
