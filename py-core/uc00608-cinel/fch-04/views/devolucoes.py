...
def criar_tela_devolucoes(frame_conteudo):
    ...
    titulo = tk.Label(frame_conteudo, text="Devolução", font=FONTE_TITULO, bg=COR_FUNDO)
    titulo.pack(pady=20)
    ...
    tk.Label(frame_formulario, text="Data Devolução:", font=FONTE_NORMAL, bg=COR_FUNDO).grid(row=2, column=0, padx=10, pady=5, sticky="w")
    ...
    tk.Button(frame_botoes, text="Registar Devolução", font=FONTE_NORMAL, bg=COR_BOTAO).pack(side="left", padx=5)
